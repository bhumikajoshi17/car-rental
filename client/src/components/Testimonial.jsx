...
const Testimonial = () => {
        ...
        {  name: "Simran Bisht" ,
         ...
         {  name: "Jay Kabdwal" ,
           ...
           rating: 5, 
           testimonial: " They made my trip so much easier. The car was delivered right to my door, and the customer service was fantastic !"
         },
         {  name: "Abhishek Chandra " ,
           location: "Haridwar, India",
           image: assets.testimonial_image_1, 
           rating: 5, 
           testimonial: "I highly recommend this CarRental! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent service."
         }  
    ];
                ...
                {testimonials.map((testimonial,index) => (
                    ...
                    key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-translate-y-1 transition-all duration-500 ">
                        <div className="flex items-center gap-3">
                            ...
                            <div >
                                <p className="f text-xl">{testimonial.name}</p>
