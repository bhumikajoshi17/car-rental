  ...
  return (
    ...
    className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <div>
        ...
        animate={{opacity:1, y:0}}
        transition={{ delay: index*0.1, duration:0.4 }}key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
          {/* Car img and info. */}
