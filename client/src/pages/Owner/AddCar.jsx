...
const AddCar = () => {
    ...
    // State to hold the car image and car details
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex flex-col w-full '> 
            <label >Year</label>
            <input type="number" placeholder='e.g. 2020, 2021...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none '
       ...
       <div className='flex flex-col w-full '> 
            ...
            <input type="number" placeholder='e.g. 100, 200...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none '
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            ...
            <input type="number" placeholder='e.g. 4, 5...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none '
        ...
        {/* Car Description */}
            ...
            <textarea rows={5} placeholder='e.g. This is a great car...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none '
